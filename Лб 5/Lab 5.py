...
def rename(filename):
    os.rename("F:\ICS-485773\ICS-485773\Лб 5\mydirectorya.txt", "F:\ICS-485773\ICS-485773\Лб 5\directorya.txt")
    print("перейменування файлу виконано") 
def delete(filename):
    os.remove("F:\ICS-485773\ICS-485773\Лб 5\directorya.txt")
    print("видалення файлу виконано")
def copy(filename):
    shutil.copyfile("F:\ICS-485773\ICS-485773\Лб 5\mydirectorya.txt", "F:\ICS-485773\ICS-485773\Лб 5\directorya.txt")
